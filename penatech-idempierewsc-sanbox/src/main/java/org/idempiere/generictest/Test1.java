...
public class Test1 {
	...
	public static List<String> getXML() {
		...
		list.add("<_0:serviceType>QueryBPartnerTest</_0:serviceType>");
		list.add("</_0:ModelCRUD>");
		list.add("<_0:ADLoginRequest>");
//		list.add("<_0:user>SuperUser</_0:user>");
		list.add("<_0:user>GardenAdmin</_0:user>");
//		list.add("<_0:pass>System</_0:pass>");
                list.add("<_0:pass>GardenAdmin</_0:pass>");
	...
	public static void main(String[] args) {
		...
		try {
//--test-oracle.idempiere.org
//			URL u = new URL("http://localhost:8080/ADInterface/services/ModelADService");
			URL u = new URL("http://192.168.43.57:8080/ADInterface/services/ModelADService"); //mac ip
//                      URL u = new URL("https://192.168.43.57:8443/ADInterface/services/ModelADService"); //mac ip
//                        URL u = new URL("https://test-oracle.idempiere.org/ADInterface/services/ModelADService");
//                        URL u = new URL("https://test-postgresql.idempiere.org/ADInterface/services/ModelADService");
//                        URL u = new URL("https://demo.globalqss.com/ADInterface/services/ModelADService");
...
//			List<String> file = readFileToList(new File("../documents/QueryBPartnerTest_request.xml"), "UTF-8");
                        List<String> file = readFileToList(new File("/home/tutnatha/NetBeansProjects/idempierewsc-sanbox/idempierewsc-sanbox/src/main/documents/QueryBPartner-01_request.xml"), "UTF-8");
