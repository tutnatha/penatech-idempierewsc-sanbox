...
public class RequestFactoryException extends Exception {
	...
	public RequestFactoryException(String message) {
		super(message);
	}

	public RequestFactoryException(Throwable cause) {
		super(cause);
	}

	public RequestFactoryException(String message, Throwable cause) {
		super(message, cause);
	}
